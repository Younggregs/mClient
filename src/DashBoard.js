...
//          link: '/patient',
        ...
        {id: 3,
          link: `${this.props.match.path}/labsMicroservice`,
          icon: 'lab',
          title: 'Laboratory',
          width: 'uk-width-1-3@m',
        ...
        {id: 6,
          link: `${this.props.match.path}/radiographyMicroservice`,
          icon: 'medkit',
          title: 'Radiography',
          width: 'uk-width-1-3@m',
        ...
        {id: 7,
          link: `${this.props.match.path}/walletMicroservice`,
          icon: 'dollar',
        ...
        {id: 8,
          link: `${this.props.match.path}/storeMicroservice`,
          icon: 'cart',
          title: 'Store',
          width: 'uk-width-1-3@m',
        ...
        {id: 9,
          link: `${this.props.match.path}/hrMicroservice`,
          icon: 'users',
